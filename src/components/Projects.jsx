...
const Projects = () => {
    return (
        <Box id="Projects" width="80%">
            <Typography variant="h3" textAlign={'center'} sx={{color: "primary.contrastText", pt: 3, pb: 3}}>Projects</Typography>
            <Box display={"flex"} flexDirection={"row"}>
                <Card variant="outlined" sx={{display: "flex", flexDirection: "column", alignItems: "center", p: 4, m: 1, flex: 1}}>
